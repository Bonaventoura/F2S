...
@section('title')
    Details du compte de {{$account->nom}} {{$account->prenoms}}
@endsection
                ...
                <div class="card">
                    <div class="card-header p-2">
                        <ul class="nav nav-pills">
                            <li class="nav-item"><a class="nav-link active" href="#activity" data-toggle="tab">Généalogie</a></li>
                            <li class="nav-item"><a class="nav-link" href="#timeline" data-toggle="tab">Projets</a></li>
                            <li class="nav-item"><a class="nav-link" href="#settings" data-toggle="tab">E-Cash</a></li>
                        </ul>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                        <div class="tab-content">
                            ...
                            <div class="active tab-pane" id="activity">
                                {{-- la liste des générations du client --}}
                                @include('espace-admin.accounts.generation')
                            </div>
                            <!-- /.tab-pane -->
