            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card shadow-lg">
                    <div class="card-header bg-olive">
                        <h4>Ajout d'un nouveau article </h4>
                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="nom_produit" name="nom_produit" placeholder="Entrez la désignation du produit" class="form-control form-control-sm">
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="qtte_stock" id="qtte_stock" placeholder="la quantité de stock initiale du produit" class="form-control form-control-sm">
                                    </div>
                                    <div class="form-group">
                                        <label for="prix_vente_gros">Prix de vente en gros</label>
                                        <input type="text" name="prix_unit_gros" id="prix_vente_gros" placeholder="le prix unitaire de vente en gros" class="form-control form-control-sm">
                                    </div>
                                    <div class="form-group">
                                        <label for="prix_unit_vente">Le prix unitaire de vente</label>
                                        <input type="text" name="prix_unit_vente" id="prix_unit_vente" placeholder="le prix unitaire de vente en détail" class="form-control form-control-sm">
                                    </div>
                                </div>
